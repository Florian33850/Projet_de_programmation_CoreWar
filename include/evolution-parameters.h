...
/// </summary>
typedef struct evolution_params_s
{
	int generations;
...
void get_warrior_distribution(evolution_params* params, int* num_warriors, int* num_survivors, int* num_mutations, int* num_breedings, int* num_fresh);
